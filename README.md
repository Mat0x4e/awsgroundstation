...
| [`docs/SYNC_PIPELINE.md`](docs/SYNC_PIPELINE.md) | The second, live demod/decode reception path (not yet flown) — architecture, how it differs from the DigIF pipeline above, and how to pick which one runs for a given contact |
